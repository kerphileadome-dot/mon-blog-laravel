...
@section('title', 'Connexion · KerpheX')
@section('subtitle', 'Connectez-vous pour commenter, liker et sauvegarder vos articles favoris.')
...
@section('content')
    ...
    <form method="POST" action="{{ route('login') }}" class="auth-form">
        ...
        <button type="submit" class="btn-primary btn-accent" style="width:100%;justify-content:center;">Se connecter</button>
    </form>
@endsection
